...
public class FirstTest {
    ...
    public void setUp() throws Exception
    {
        ...
        capabilities.setCapability("app","/Users/Vadim/Desktop/JavaAppiumAutomation/apks/org.wikipedia.apk");
    ...
    public void testCancelSearch()
    {
        ...
        waitForElementNotPresent(
                By.id("org.wikipedia:id/search_close_btn"),
                "X is still present on this page",
                5
        );
    }
    ...
    public  void  testAmountOfNotEmptySearch()
    {
        ...
        int anount_of_search_results = getAmountOfElements(
                By.xpath(search_result_locator)
        );

        Assert.assertTrue(
                "We found too few results",
                anount_of_search_results > 0
        );
    }
    ...
    public void testAmountOfEmptySearch()
    {
        ...
        String search_line = "jyfyhvcifch";
    ...
    {
        int amount_of_elemants = getAmountOfElements(by);
        if (amount_of_elemants > 0) {
            String default_message = "An element '" + by.toString() + "' supposed to be not present";
            throw  new AssertionError(default_message + " " + error_message);
        }
    }

    private String waitForElementAndGetAttribute(By by, String attribute, String error_message, long timeoutInSеconds)
    {
        WebElement element = waitForElementPresent(by, error_message, timeoutInSеconds);
